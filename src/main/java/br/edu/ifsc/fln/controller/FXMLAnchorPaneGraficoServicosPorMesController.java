 ...
 * @author mpisching
 */
public class FXMLAnchorPaneGraficoServicosPorMesController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Map<Integer, ArrayList> dados = OrdemServicoDAO.listarQuantidadeServicosPorMes();
